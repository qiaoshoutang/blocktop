        ...
        !
            function(t, n) {
                ...
                function w(e, t, n, r, i) {
                    for (var o, a, s, u, l, c, f, d = e.length, p = y(t), h = [], g = 0; g < d; g++) if (a = e[g], a || 0 === a) if ("object" === ye.type(a)) ye.merge(h, a.nodeType ? [a] : a);
                    else if (Ge.test(a)) {
                ...
                ye.fn = ye.prototype = {
                    ...
                    map: function(e, t, n) {
                        var r, i, o = 0,
                            s = [];
                        if (a(e)) for (r = e.length; o < r; o++) i = t(e[o], o, n), null != i && s.push(i);
